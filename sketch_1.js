...
//Begin game once the user clicks the screen
function mouseClicked() {
  begin = true;
}

//Create function for generating the obstacle drone's height
...
function draw() {
    ...
    //Increase frame coutner by 1 after every frame
    frameCounter += 1;
...
class Obstacle {
  ...
  // Check if the runner has collided with the drone
  checkCollision() {
